...
- Experience implementing RBAC, authentication, CSRF protection, rate limiting, request throttling, validation, and audit logging
...
**Lord of Zion Divine School | June 2026 to Present**

- Maintain and support computers, networks, and IT systems
- Troubleshoot technical issues for staff and students
- Teach programming and web development fundamentals, including HTML/CSS, C#, and ASP.NET
- Develop programming materials and laboratory activities
...
`Linux/Unix` · `CI/CD` · `Microsoft Azure Fundamentals` · `Google Cloud Fundamentals`
